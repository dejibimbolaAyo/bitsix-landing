...
import { EngineersForHireBlocksEngineersForHireEngagementProcess } from "@tina/__generated__/types";

interface EngineersForHireEngagementProcessProps {
  data: EngineersForHireBlocksEngineersForHireEngagementProcess;
}

const EngineersForHireEngagementProcess: React.FC<
  EngineersForHireEngagementProcessProps
> = ({ data }) => {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              {data.engineersForHireEngagementProcessContent && (
                ...
                >
                  <TinaMarkdown
                    content={data.engineersForHireEngagementProcessContent}
                  />
                </div>
              )}
              {data.engineersForHireEngagementProcessCtaText &&
                data.engineersForHireEngagementProcessCtaLink && (
                  <div>
                    <Link
                      to={data.engineersForHireEngagementProcessCtaLink}
              ...
              <div className="lg:col-span-5 relative w-full flex justify-center">
                <div className="relative w-full max-w-sm lg:max-w-none aspect-[4/3] rounded-2xl overflow-hidden shadow-lg border border-white/10">
                  <img
                    data-tina-field={tinaField(
                      data,
                      "engineersForHireEngagementProcessImage"
                    )}
