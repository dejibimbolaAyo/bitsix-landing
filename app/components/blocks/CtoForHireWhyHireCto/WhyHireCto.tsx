...
import { CtoForHireBlocksCtoForHireWhyHireCto } from "@tina/__generated__/types";

interface CtoForHireWhyHireCtoProps {
  data: CtoForHireBlocksCtoForHireWhyHireCto;
}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {data.ctoForHireWhyHireCtoImage && (
            <div className="lg:col-span-5 order-2 lg:order-1 relative w-full flex justify-center">
              <div className="relative w-full max-w-md lg:max-w-none aspect-[4/3] sm:aspect-video lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-xl border border-slate-100">
                <img
                  data-tina-field={tinaField(data, "ctoForHireWhyHireCtoImage")}
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 flex flex-col items-start">
            <h2
              data-tina-field={tinaField(data, "ctoForHireWhyHireCtoTitle")}
              className="text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight mb-4"
            >
              {data.ctoForHireWhyHireCtoTitle}
            </h2>
            {data.ctoForHireWhyHireCtoSubtitle && (
              <p
                data-tina-field={tinaField(data, "ctoForHireWhyHireCtoSubtitle")}
            ...
            {data.ctoForHireWhyHireCtoContent && (
              <div
                data-tina-field={tinaField(data, "ctoForHireWhyHireCtoContent")}
            ...
            {data.ctoForHireWhyHireCtoCtaText &&
              data.ctoForHireWhyHireCtoCtaLink && (
                <div className="mt-2">
                  <Link
                    to={data.ctoForHireWhyHireCtoCtaLink}
